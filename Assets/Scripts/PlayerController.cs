...
public class PlayerController : MonoBehaviour {
	...
	IEnumerator appetizers () {														//appetizers subroutine
		txt.text = "Please select the appetizer you want to prepare by pressing the corresponding button: \n1: " + app1.name + "\n2: " + app2.name + 
				"\n3: " + app3.name + "\n4: " + app4.name;
		yield return StartCoroutine (waitforinput4 ());
	...
	IEnumerator firstcourses() {													//first courses subroutine
		txt.text = "Please select the first course you want to prepare by pressing the corresponding button: \n1: " + fc1.name + "\n2: " + fc2.name +
		"\n3: " + fc3.name + "\n4: " + fc4.name + "\n5: " + fc5.name;
		yield return StartCoroutine (waitforinput5 ());
		if (Input.GetKeyDown("1"))
			CurrRec = fc1;
		if (Input.GetKeyDown("2"))
			CurrRec = fc2;
	...
	IEnumerator secondcourses() {													//second courses subroutine
		txt.text = "Please select the second course you want to prepare by pressing the corresponding button: \n1: " + sc1.name + "\n2: " + sc2.name +
			"\n3: " + sc3.name + "\n4: " + sc4.name + "\n5: " + sc5.name;
		yield return StartCoroutine (waitforinput5 ());
		if (Input.GetKeyDown("1"))
			CurrRec = sc1;
	...
	IEnumerator desserts () {														//desserts subroutine
		txt.text = "Please select the dessert you want to prepare by pressing the corresponding button: \n1: " + de1.name + "\n2: " + de2.name + 
			"\n3: " + de3.name + "\n4: " + de4.name;
		yield return StartCoroutine (waitforinput4 ());
		if (Input.GetKeyDown("1"))
			CurrRec = de1;
	...
	IEnumerator waitforinput5 () {													//stop script until a valid input is given
		while (!Input.GetKeyDown ("1") && !Input.GetKeyDown ("2") && !Input.GetKeyDown ("3") && !Input.GetKeyDown ("4") && !Input.GetKeyDown("5"))
			yield return null;
	}

	IEnumerator waitforinput4 () {													//stop script until a valid input is given
